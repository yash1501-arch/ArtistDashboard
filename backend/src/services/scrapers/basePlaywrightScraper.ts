...
export abstract class BasePlaywrightScraper implements ConcertSourceScraper {
  ...
  private textFrom(root: cheerio.Cheerio, selectors: string[]): string | undefined {
  ...
  private attrFrom(root: cheerio.Cheerio, selectors: string[], attribute: string): string | undefined {
    for (const selector of selectors) {
